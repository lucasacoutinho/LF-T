...
<head>
    ...
    <title>LiberflyAPI Documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-login">Login</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-authenticated">
                                <a href="#authentication-POSTapi-authenticated">Authenticated</a>
                            </li>
...
<p>This endpoint lets you authenticate.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>O e-mail do usuário. Must be a valid email address. Example: <code>usuario@email.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>A senha do usuário. Example: <code>12345678</code></p>
        </div>
        </form>

                    <h2 id="authentication-POSTapi-authenticated">Authenticated</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Return a authenticated user.</p>

<span id="example-requests-POSTapi-authenticated">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/authenticated" \
...
<span id="example-responses-POSTapi-authenticated">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-authenticated" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-authenticated"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-authenticated"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-authenticated" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-authenticated">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-authenticated" data-method="POST"
      data-path="api/authenticated"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-authenticated', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-authenticated"
                    onclick="tryItOut('POSTapi-authenticated');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-authenticated"
                    onclick="cancelTryOut('POSTapi-authenticated');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-authenticated"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/authenticated</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Authorization" class="auth-value"               data-endpoint="POSTapi-authenticated"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Content-Type"                data-endpoint="POSTapi-authenticated"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Accept"                data-endpoint="POSTapi-authenticated"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>This endpoint lets you logout.</p>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="task-management">Task management</h1>
                                ...
                                <h2 id="task-management-GETapi-tasks">Tasks</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint return the user tasks.</p>
...
<code class="language-json" style="max-height: 300px;">[
    {
        &quot;id&quot;: 1,
        &quot;description&quot;: &quot;Fugit assumenda soluta voluptates repellat itaque.&quot;,
        &quot;completed&quot;: true,
        &quot;user_id&quot;: 1
    },
    {
        &quot;id&quot;: 2,
        &quot;description&quot;: &quot;Amet voluptatum et distinctio praesentium ea qui voluptas.&quot;,
        &quot;completed&quot;: true,
        &quot;user_id&quot;: 1
    },
    {
        &quot;id&quot;: 3,
        &quot;description&quot;: &quot;Aut qui doloribus velit accusantium fugit qui aliquid.&quot;,
        &quot;completed&quot;: true,
        &quot;user_id&quot;: 1
    },
    {
        &quot;id&quot;: 4,
        &quot;description&quot;: &quot;Sunt et omnis est magni eos omnis quia.&quot;,
        &quot;completed&quot;: true,
        &quot;user_id&quot;: 1
    },
    {
        &quot;id&quot;: 5,
        &quot;description&quot;: &quot;Qui laudantium quia sed dolorem dolor itaque libero.&quot;,
        &quot;completed&quot;: false,
        &quot;user_id&quot;: 1
    },
    {
        &quot;id&quot;: 6,
        &quot;description&quot;: &quot;Voluptatem temporibus a delectus vel.&quot;,
        &quot;completed&quot;: true,
        &quot;user_id&quot;: 1
    },
    {
        &quot;id&quot;: 7,
        &quot;description&quot;: &quot;Sit eius quaerat dolores eos necessitatibus error.&quot;,
        &quot;completed&quot;: false,
        &quot;user_id&quot;: 1
    },
    {
        &quot;id&quot;: 8,
        &quot;description&quot;: &quot;Quo porro dolor ad aut.&quot;,
        &quot;completed&quot;: false,
        &quot;user_id&quot;: 1
    },
    {
        &quot;id&quot;: 9,
        &quot;description&quot;: &quot;Voluptate ea minima at id expedita aliquid commodi.&quot;,
        &quot;completed&quot;: true,
        &quot;user_id&quot;: 1
    },
    {
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="task-management-POSTapi-tasks">New Task</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint create a new task.</p>
...
<p>A descrição da tarefa. Example: <code>Reprehenderit magni eveniet nesciunt nulla iusto aut.</code></p>
                    ...
                    <h2 id="task-management-GETapi-tasks--id-">Find Task</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint return a task.</p>
...
<p>This endpoint update a task.</p>
...
<i>optional</i> &nbsp;
    ...
    <br>
<p>O status da tarefa. Example: <code>false</code></p>
        </div>
        </form>
...
<p>This endpoint delete a task.</p>
